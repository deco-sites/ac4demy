    ...
    courses: [
        {
            ...
            description: "<h2>O que você aprenderá:</h2><p>Configurar o seu primeiro setup em deco.cx</p>",
            ...
            details: [
                { title: "Detalhe 1", text: "Texto do detalhe 1", difficulty: "Iniciante" },
                // Mais detalhes...
            ],
            courseIncludes: [
            ...
            tabsCourse: [
                {
                    title: "Sobre o curso",
                    content: "<h2>O que você aprenderá:</h2><p>Configurar o seu primeiro setup em deco.cx</p>",
                },
            ],
        },
    ],
...
export const loader = (props: Props, req: Request) => {
    ...
    const courseItem = courses.find(({ url }) => url && new URL(req.url).pathname.includes(url));
...
export default function CoursePage({ courseItem }: SectionProps<ReturnType<typeof loader>>) {
    if (!courseItem) {
    ...
    const {
        ...
        title = "Aprendendo a configurar o setup com deco.cx",
        instructor = "Por: Rafael Oliveira",
        description = "<h2>O que você aprenderá:</h2><p><br></p><p>Configurar o seu primeiro setup em deco.cx</p>",
        excerpt = "Configurar o seu primeiro setup em deco.cx",
        image = DEFAULT_IMAGE,
        ...
        <div class="p-6 flex flex-col md:flex-row gap-10">
            ...
            <div class="w-3/4 mx-auto flex flex-col gap-4">
                ...
                <div class="flex items-center justify-between py-4">
                        ...
                        <div class="flex items-center text-yellow-500">
                            {[...Array(5)].map((_, index) => (
                                <svg key={index} width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.875 0.25L10.2266 4.73438L15.2305 5.60938L11.7031 9.24609L12.4141 14.25L7.875 12.0352L3.30859 14.25L4.04688 9.24609L0.492188 5.60938L5.49609 4.73438L7.875 0.25Z" fill="#EBBA6B" />
                                </svg>
                            ))}
                        </div>
                    ...
                    <div class="flex items-center">
                        <img src={imageInstructor} alt="Instructor" class="w-6 h-6 rounded-2xl mr-4" />
