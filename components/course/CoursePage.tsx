...
export default function CoursePage({ course }: Props) {
  const {
    ...
    description =
      "<h2>O que você aprenderá:</h2><p><br></p><p>Configurar o seu primeiro setup em deco.cx</p><p><br></p><p>Desenvolver raciocínio lógico de setup</p><p><br></p><p>Aprender o básico da plataforma da deco.cx</p>",
    ...
    details = [
      ...
      {
        title: "Detalhe 2",
        text: "Texto do detalhe 2",
        difficulty: "Intermediário",
      },
      {
        title: "Detalhe 3",
        text: "Texto do detalhe 3",
        difficulty: "Avançado",
      },
    ],
    courseIncludes = [
    ...
    tabsCourse = [
      {
        title: "Sobre o curso",
        content:
          "<h2>O que você aprenderá:</h2><p><br></p><p>Configurar o seu primeiro setup em deco.cx</p><p><br></p><p>Desenvolver raciocínio lógico de setup</p>",
      },
      {
        title: "Conteúdos",
        content:
          "<h2>O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:O que você aprenderá:</h2><p><br></p><p>Configurar o seu primeiro setup em deco.cx</p><p><br></p><p>Desenvolver raciocínio lógico de setup</p>",
      },
      {
        title: "Detalhes",
        content:
