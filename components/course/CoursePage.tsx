...
export default function CoursePage({ course }: Props) {
    const {
        ...
        description = "<h2>O que você aprenderá:</h2><p><br></p><p>Configurar o seu primeiro setup em deco.cx</p><p><br></p><p>Desenvolver raciocínio lógico de setup</p><p><br></p><p>Aprender o básico da plataforma da deco.cx</p>",
        ...
        sections = [
            ...
            { title: "Primeiros passos", duration: "05:45" },
            { title: "Execução 1", duration: "05:45" },
            { title: "Execução 2", duration: "05:45" },
            { title: "Execução 3", duration: "05:45" },
            { title: "Finalização", duration: "05:45" },
        ],
        details = [
